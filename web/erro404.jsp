...
.safe-browsing :-webkit-any(
    a, #details, #details-button, h1, h2, p) {
  color: white;
}
...
<div id="main-frame-error" class="interstitial-wrapper" jstcache="0">
    <div class="onlyforchrome" style="font-size: 30px;text-align: center;font-family: Helvetica;">Erro 404 :(</div>
    <div class="onlyforchrome" style="margin-top:5px;text-align:center;color:#8a8a8a;margin-bottom:80px; font-size:.8em;line-height:1.2em;font-family: Georgia;">
        <a href="index.jsp" target="_blank"><strong>LP3 - 2019</strong></a> Professor Marco Antonio &copy; <a href="index.jsp" target="_blank"><strong>Gerenciamento de Espaços.</strong></a>
        <br/> Pressione "Espaço" ou use as setas para jogar com o Dino</div>
