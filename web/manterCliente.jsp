                ...
                <div class="col-lg-12">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <input type="HIDDEN" required="required" maxlength="10" min="1" max="9999999999" data-ls-module="charCounter"  onkeyup="validare(this, 'numero')" autocomplete="off" placeholder="Digite um codigo"  class="form-control" name="id"   value="${cliente.id}"  required autofocus<c:if test="${operacao != 'Incluir'}"> readonly</c:if>/>
